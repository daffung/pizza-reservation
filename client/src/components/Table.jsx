...
const Table = props =>{
    const getRow1 =_=>{
        let chairs=[];
        for(let i=1;i<Math.ceil(props.chairs / 2);i++){
            chairs.push(
                <span key={i} className={props.empty? "empty-table": "full-table"}></span>
            )
        }
        return chairs;
    }
    ...
    return(
        <div className="table-container">
            ...
            onClick={_ =>{props.empty? props.selectTable(props.name,props.id):
